...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'BritishGas|AmericaHomeShield|shell|BordGais|Centrica';
...
**/
'BritishGas|AmericaHomeShield|shell|BordGais|Centrica'
function loadData() {
  get('brand_counts.json', function(data) {
    var brandData = JSON.parse(data);
    var brandCountsHolder = brandData["count"];
    brandCounts = [
    {x: "British Gas", value: brandCountsHolder["BritishGas"]},
    {x: "America Home Shield", value: brandCountsHolder["AmericaHomeShield"]},
    {x: "Shell", value: brandCountsHolder["shell"]},
    {x: "Bord Gais", value: brandCountsHolder["BordGais"]},
    {x: "Centrica", value: brandCountsHolder["Centrica"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x + 25360)/(39380 + 25360)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y + 12976)/(38368 + 12976)) * 193) - marker.Height;
    ...
    clusterCounts = [
    {x: "British Gas", value: thisClusterData["BritishGas"]},
    {x: "America Home Shield", value: thisClusterData["AmericaHomeShield"]},
    {x: "Shell", value: thisClusterData["shell"]},
    {x: "Bord Gais", value: thisClusterData["BordGais"]},
    {x: "Centrica", value: thisClusterData["Centrica"]}
    ]
...
mapSprite.src = "assets/images/Gas Full Map.png";
